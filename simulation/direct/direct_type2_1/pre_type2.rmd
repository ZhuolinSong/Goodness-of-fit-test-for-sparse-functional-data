...
load("simulation/direct_type2/direct_quad_5004_2.RData")
load("simulation/direct_type2/direct_quad_5004_3.RData")
load("simulation/direct_type2/direct_quad_5004_4.RData")
load("simulation/direct_type2/direct_quad_5004_5.RData")
...
save(direct_5004_quad, file = "direct_5004_quad.RData")
```
```{r, direct_5007_quad.bs, eval = F, include = F}
load("simulation/direct_type2/direct_quad_5007_2.RData")
load("simulation/direct_type2/direct_quad_5007_3.RData")
load("simulation/direct_type2/direct_quad_5007_4.RData")
load("simulation/direct_type2/direct_quad_5007_5.RData")
...
save(direct_5007_quad, file = "direct_5007_quad.RData")
```
...
load("direct_5004_quad.RData") # simulation/direct_type2/
for (i in 1:4) {
...
load("simulation/direct_type2/direct_trig_5004_2.RData")
load("simulation/direct_type2/direct_trig_5004_3.RData")
load("simulation/direct_type2/direct_trig_5004_4.RData")
load("simulation/direct_type2/direct_trig_5004_5.RData")
...
save(direct_5004_trig, file = "direct_5004_trig.RData")
```
```{r, direct_5007_trig.bs, eval = F, include = F}
load("simulation/direct_type2/direct_trig_5007_2.RData")
load("simulation/direct_type2/direct_trig_5007_3.RData")
load("simulation/direct_type2/direct_trig_5007_4.RData")
load("simulation/direct_type2/direct_trig_5007_5.RData")
...
save(direct_5007_trig, file = "direct_5007_trig.RData")
```
...
load("direct_5004_trig.RData") # simulation/direct_type2/
for (i in 1:4) {
...
load("direct_5007_trig.RData") # simulation/rmd/
for (i in 1:4) {
