...
load("simulation/approx/approx_type2_025/another/an_code_quad_5004_2.RData")
load("simulation/approx/approx_type2_025/another/an_code_quad_5004_3.RData")
load("simulation/approx/approx_type2_025/another/an_code_quad_5004_4.RData")
load("simulation/approx/approx_type2_025/another/an_code_quad_5004_5.RData")
an_code_5004_quad <- c(an_code_5004_2, an_code_5004_3, an_code_5004_4, an_code_5004_5)
for (i in 1:4) {
    temp <- 2 * i
    m_size[1, i] <- (an_code_5004_quad[[temp-1]][[1]] + an_code_5004_quad[[temp]][[1]])/2
}

an_code_5004_quad <- list(
    m_size[1, ]
)
save(an_code_5004_quad, file = "an_code_5004_quad.RData")
```

```{r, an_code_5007_quad.bs, eval = F, include = F}
load("simulation/approx/approx_type2_025/another/an_code_quad_5007_2.RData")
load("simulation/approx/approx_type2_025/another/an_code_quad_5007_3.RData")
load("simulation/approx/approx_type2_025/another/an_code_quad_5007_4.RData")
load("simulation/approx/approx_type2_025/another/an_code_quad_5007_5.RData")
an_code_5007_quad <- c(an_code_5007_2, an_code_5007_3, an_code_5007_4, an_code_5007_5)
for (i in 1:4) {
    temp <- 2 * i
    m_size[2, i] <- (an_code_5007_quad[[temp-1]][[1]] + an_code_5007_quad[[temp]][[1]])/2
}

an_code_5007_quad <- list(
    m_size[2, ]
)
save(an_code_5007_quad, file = "an_code_5007_quad.RData")
```
...
```{r, an_code_5004_trig.bs, eval = F, include = F}
load("simulation/approx/approx_type2_025/another/an_code_trig_5004_2.RData")
load("simulation/approx/approx_type2_025/another/an_code_trig_5004_3.RData")
load("simulation/approx/approx_type2_025/another/an_code_trig_5004_4.RData")
load("simulation/approx/approx_type2_025/another/an_code_trig_5004_5.RData")
an_code_5004_trig <- c(an_code_5004_2, an_code_5004_3, an_code_5004_4, an_code_5004_5)
for (i in 1:4) {
    temp <- 2 * i
    m_size[1, i] <- (an_code_5004_trig[[temp-1]][[1]] + an_code_5004_trig[[temp]][[1]])/2
}

an_code_5004_trig <- list(
    m_size[1, ]
)
save(an_code_5004_trig, file = "an_code_5004_trig.RData")
```
```{r, an_code_5007_trig.bs, eval = F, include = F}
load("simulation/approx/approx_type2_025/another/an_code_trig_5007_2.RData")
load("simulation/approx/approx_type2_025/another/an_code_trig_5007_3.RData")
load("simulation/approx/approx_type2_025/another/an_code_trig_5007_4.RData")
load("simulation/approx/approx_type2_025/another/an_code_trig_5007_5.RData")
an_code_5007_trig <- c(an_code_5007_2, an_code_5007_3, an_code_5007_4, an_code_5007_5)
for (i in 1:4) {
    temp <- 2 * i
    m_size[2, i] <- (an_code_5007_trig[[temp-1]][[1]] + an_code_5007_trig[[temp]][[1]])/2
}

an_code_5007_trig <- list(
    m_size[2, ]
)
save(an_code_5007_trig, file = "an_code_5007_trig.RData")
```
