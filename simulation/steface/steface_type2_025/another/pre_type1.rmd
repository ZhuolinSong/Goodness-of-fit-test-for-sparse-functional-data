...
```
```{r, an_steface_5004_quad.bs, eval = F, include = F}
load("simulation/steface/steface_type2_025/another/an_steface_quad_5004_2.RData")
load("simulation/steface/steface_type2_025/another/an_steface_quad_5004_3.RData")
load("simulation/steface/steface_type2_025/another/an_steface_quad_5004_4.RData")
load("simulation/steface/steface_type2_025/another/an_steface_quad_5004_5.RData")
an_steface_5004_quad <- c(an_steface_5004_2, an_steface_5004_3, an_steface_5004_4, an_steface_5004_5)
for (i in 1:4) {
    temp <- 2 * i
    m_size[1, i] <- (an_steface_5004_quad[[temp-1]][[1]] + an_steface_5004_quad[[temp]][[1]])/2
}

an_steface_5004_quad <- list(
    m_size[1, ]
)
save(an_steface_5004_quad, file = "an_steface_5004_quad.RData")
```
```{r, an_steface_5007_quad.bs, eval = F, include = F}
load("simulation/steface/steface_type2_025/another/an_steface_quad_5007_2.RData")
load("simulation/steface/steface_type2_025/another/an_steface_quad_5007_3.RData")
load("simulation/steface/steface_type2_025/another/an_steface_quad_5007_4.RData")
load("simulation/steface/steface_type2_025/another/an_steface_quad_5007_5.RData")
an_steface_5007_quad <- c(an_steface_5007_2, an_steface_5007_3, an_steface_5007_4, an_steface_5007_5)
for (i in 1:4) {
    temp <- 2 * i
    m_size[2, i] <- (an_steface_5007_quad[[temp-1]][[1]] + an_steface_5007_quad[[temp]][[1]])/2
}

an_steface_5007_quad <- list(
    m_size[2, ]
)
save(an_steface_5007_quad, file = "an_steface_5007_quad.RData")
```
...
load("an_steface_5004_quad.RData") # simulation/an_steface_type2/
for (i in 1:4) {
    m_size[1, i] <- an_steface_5004_quad[[1]][[i]]
}
...
for (i in 1:4) {
    m_size[2, i] <- an_steface_5007_quad[[1]][[i]]
}
...
m_plain <- matrix(NA, nrow = 2, ncol = 4)
```
```{r, an_steface_5004_trig.bs, eval = F, include = F}
load("simulation/steface/steface_type2_025/another/an_steface_trig_5004_2.RData")
load("simulation/steface/steface_type2_025/another/an_steface_trig_5004_3.RData")
load("simulation/steface/steface_type2_025/another/an_steface_trig_5004_4.RData")
load("simulation/steface/steface_type2_025/another/an_steface_trig_5004_5.RData")
an_steface_5004_trig <- c(an_steface_5004_2, an_steface_5004_3, an_steface_5004_4, an_steface_5004_5)
for (i in 1:4) {
    temp <- 2 * i
    m_size[1, i] <- (an_steface_5004_trig[[temp-1]][[1]] + an_steface_5004_trig[[temp]][[1]])/2
}

an_steface_5004_trig <- list(
    m_size[1, ]
)
save(an_steface_5004_trig, file = "an_steface_5004_trig.RData")
```
```{r, an_steface_5007_trig.bs, eval = F, include = F}
load("simulation/steface/steface_type2_025/another/an_steface_trig_5007_2.RData")
load("simulation/steface/steface_type2_025/another/an_steface_trig_5007_3.RData")
load("simulation/steface/steface_type2_025/another/an_steface_trig_5007_4.RData")
load("simulation/steface/steface_type2_025/another/an_steface_trig_5007_5.RData")
an_steface_5007_trig <- c(an_steface_5007_2, an_steface_5007_3, an_steface_5007_4, an_steface_5007_5)
for (i in 1:4) {
    temp <- 2 * i
    m_size[2, i] <- (an_steface_5007_trig[[temp-1]][[1]] + an_steface_5007_trig[[temp]][[1]])/2
}

an_steface_5007_trig <- list(
    m_size[2, ]
)
save(an_steface_5007_trig, file = "an_steface_5007_trig.RData")
```

```{r, plain_5004_trig.bs, eval = F, include = F}
load("plain_trig_5004_2.RData")
load("plain_trig_5004_3.RData")
load("plain_trig_5004_4.RData")
load("plain_trig_5004_5.RData")
...
load("plain_trig_5007_2.RData")
load("plain_trig_5007_3.RData")
load("plain_trig_5007_4.RData")
load("plain_trig_5007_5.RData")
...
load("code_trig_5004_2.RData")
load("code_trig_5004_3.RData")
load("code_trig_5004_4.RData")
load("code_trig_5004_5.RData")
...
load("code_trig_5007_2.RData")
load("code_trig_5007_3.RData")
load("code_trig_5007_4.RData")
load("code_trig_5007_5.RData")
...
load("an_steface_5004_trig.RData") # simulation/an_steface_type2/
for (i in 1:4) {
    m_size[1, i] <- an_steface_5004_trig[[1]][[i]]
}
...
load("an_steface_5007_trig.RData") # simulation/rmd/
for (i in 1:4) {
    m_size[2, i] <- an_steface_5007_trig[[1]][[i]]
}
