...
legend("bottomright",
    legend = c("Ftest(whole), m = 7", "Ftest(t=80), m = 7", "orig, m = 7", "Ftest(whole), m = 4", "Ftest(t=80), m = 4", "bootstrap, m = 4"),
    col = rep(c("black", "red", "blue"), 2), lty = rep(1:2, each = 3), lwd = rep(2, 6)
)
