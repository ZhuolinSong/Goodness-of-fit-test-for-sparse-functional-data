...
m_sigma2_mse <- matrix(0, nrow = 2, ncol = 1)
```
```{r, code_5004_025.bs, eval = F, include = F}
load("simulation/rmd/code_5004_1_025.RData") # simulation/rmd/
load("simulation/rmd/code_5004_2_025.RData")
load("simulation/rmd/code_5004_3_025.RData")
load("simulation/rmd/code_5004_4_025.RData")
load("simulation/rmd/code_5004_5_025.RData")
...
seed.bs <- sapply(code_5004, seed <- function(l_list) {
    l_list[[3]]
})
code_5004_025 <- list(
    m_size[1, ],
...
save(code_5004_025, file = "code_5004_025.RData")
```
```{r, code_5007_025.bs, eval = F, include = F}
load("simulation/rmd/code_5007_1_025.RData") # simulation/rmd/
load("simulation/rmd/code_5007_2_025.RData")
load("simulation/rmd/code_5007_3_025.RData")
load("simulation/rmd/code_5007_4_025.RData")
load("simulation/rmd/code_5007_5_025.RData")
...
seed.bs <- sapply(code_5007, seed <- function(l_list) {
    l_list[[3]]
})
code_5007_025 <- list(
    m_size[2, ],
...
save(code_5007_025, file = "code_5007_025.RData")
```
```{r, code_5004_025, include = F}
load("code_5004_025.RData") # simulation/rmd/
m_size[1, ] <- code_5004_025[[1]] / 10
m_sigma2_mse[1, ] <- code_5004_025[[2]] / 10
```
```{r, code_5007_025, include = F}
load("code_5007_025.RData")
m_size[2, ] <- code_5007_025[[1]] / 10
m_sigma2_mse[2, ] <- code_5007_025[[2]] / 10
```
```{r, summary code_500_025}
print("summary for code 500 sigma = 0.25")
m_size
m_sigma2_mse
```
...
m_sigma2_mse <- matrix(0, nrow = 2, ncol = 1)
```
```{r, code_5004_04.bs, eval = F, include = F}
load("simulation/rmd/code_5004_1_4.RData") # simulation/rmd/
load("simulation/rmd/code_5004_2_4.RData")
load("simulation/rmd/code_5004_3_4.RData")
load("simulation/rmd/code_5004_4_4.RData")
load("simulation/rmd/code_5004_5_4.RData")
code_5004 <- c(code_5004_1, code_5004_2, code_5004_3, code_5004_4, code_5004_5)
for (i in seq_along(code_5004)) {
    m_size[1, ] <- m_size[1, ] + code_5004[[i]][[1]]
    m_sigma2_mse[1, ] <- m_sigma2_mse[1, ] + code_5004[[i]][[2]]
...
save(code_5004_04, file = "code_5004_04.RData")
```
```{r, code_5007_04.bs, eval = F, include = F}
load("simulation/rmd/code_5007_1_4.RData") # simulation/rmd/
load("simulation/rmd/code_5007_2_4.RData")
load("simulation/rmd/code_5007_3_4.RData")
load("simulation/rmd/code_5007_4_4.RData")
load("simulation/rmd/code_5007_5_4.RData")
code_5007 <- c(code_5007_1, code_5007_2, code_5007_3, code_5007_4, code_5007_5)
for (i in seq_along(code_5007)) {
    m_size[2, ] <- m_size[2, ] + code_5007[[i]][[1]]
    m_sigma2_mse[2, ] <- m_sigma2_mse[2, ] + code_5007[[i]][[2]]
...
save(code_5007_04, file = "code_5007_04.RData")
```
```{r, code_5004_04, include = F}
load("code_5004_04.RData") # simulation/rmd/
m_size[1, ] <- code_5004_04[[1]] / 10
m_sigma2_mse[1, ] <- code_5004_04[[2]] / 10
```
```{r, code_5007_04, include = F}
load("code_5007_04.RData")
m_size[2, ] <- code_5007_04[[1]] / 10
m_sigma2_mse[2, ] <- code_5007_04[[2]] / 10
```
```{r, summary code_500_04}
print("summary for code 500 sigma = 4")
m_size
m_sigma2_mse
```
...
load("simulation/rmd/steface_trig_5004_2.RData")
load("simulation/rmd/steface_trig_5004_3.RData")
load("simulation/rmd/steface_trig_5004_4.RData")
load("simulation/rmd/steface_trig_5004_5.RData")
...
load("simulation/rmd/steface_trig_5007_2.RData")
load("simulation/rmd/steface_trig_5007_3.RData")
load("simulation/rmd/steface_trig_5007_4.RData")
load("simulation/rmd/steface_trig_5007_5.RData")
...
load("steface_5004_trig.RData") # simulation/rmd/
for (i in 1:4) {
    m_size[1, i] <- steface_5004_trig[[1]][[i]]
}
# load("code_trig_5004.RData")
# for (i in 1:4) {
#     m_code[1, i] <- code_trig_1004[[i]][[1]]
# }
# load("plain_trig_5004.RData")
# for (i in 1:4) {
#     m_plain[1, i] <- code_trig_1004[[i]][[1]]
# }
```
...
# load("code_trig_5007.RData")
# for (i in 1:4) {
#     m_code[2, i] <- code_trig_1007[[i]][[1]]
# }
# load("plain_trig_5007.RData")
# for (i in 1:4) {
#     m_plain[2, i] <- code_trig_1007[[i]][[1]]
# }
```
