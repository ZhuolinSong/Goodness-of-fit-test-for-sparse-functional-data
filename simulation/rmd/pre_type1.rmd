...
lines(v_dev, c(0.0444, m_size[2, ]), ylim = c(0, 1), lty = 1, col = "black")
lines(v_dev, c(0.1074, m_code[1, ]), ylim = c(0, 1), lty = 2, col = "grey")
lines(v_dev, c(0.0752, m_code[2, ]), ylim = c(0, 1), lty = 2, col = "black")
legend("bottomright",
    legend = c("steface, m = 4", "steface, m = 7", "orig, m = 4", "orig, m = 7"),
    col = c("grey", 1, "grey", 1), lty = c(1, 1, 2, 2)
)
...
plot(
    ...
    v_dev, c(0.0524, m_size[1, ]), ylim = c(0, 1), type = "l", lty = 1, col = "grey"
)
lines(v_dev, c(0.0444, m_size[2, ]), ylim = c(0, 1), lty = 1, col = "black")
lines(v_dev, c(0.1074, m_code[1, ]), ylim = c(0, 1), lty = 2, col = "grey")
lines(v_dev, c(0.0752, m_code[2, ]), ylim = c(0, 1), lty = 2, col = "black")
