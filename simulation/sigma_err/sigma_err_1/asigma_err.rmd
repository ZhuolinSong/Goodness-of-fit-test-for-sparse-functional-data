...
pdf(file = "err_histogram_1.pdf", height = 4, width = 16)
par(mfrow = c(1, 4))
hist(face_1004, col=rgb(1,0,0,0.5),xlim=c(0,1.5), ylim=c(0,8), main=expression(paste(n == 100, ", ", bar(m) == 4)), freq = F, xlab = '', ylab = '')
hist(orig_1004, col=rgb(0,0,1,0.5), add=T, freq = F)
abline(v = 1, lwd = 3)

hist(face_1007, col=rgb(1,0,0,0.5),xlim=c(0,1.5), ylim=c(0,8), main=expression(paste(n == 100, ", ", bar(m) == 7)), freq = F, xlab = '', ylab = '')
hist(orig_1007, col=rgb(0,0,1,0.5), add=T, freq = F)
abline(v = 1, lwd = 3)

hist(face_5004, col=rgb(1,0,0,0.5),xlim=c(0,1.5), ylim=c(0,8), main=expression(paste(n == 500, ", ", bar(m) == 4)), freq = F, xlab = '', ylab = '')
hist(orig_5004, col=rgb(0,0,1,0.5), add=T, freq = F)
abline(v = 1, lwd = 3)

hist(face_5007, col=rgb(1,0,0,0.5),xlim=c(0,1.5), ylim=c(0,8), main=expression(paste(n == 500, ", ", bar(m) == 7)), freq = F, xlab = '', ylab = '')
hist(orig_5007, col=rgb(0,0,1,0.5), add=T, freq = F)
abline(v = 1, lwd = 3)
